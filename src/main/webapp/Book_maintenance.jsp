    ...
    <head>
        ...
        * {
        ...
        .maintenance-page {
            ...
            background: linear-gradient(135deg, #f8faf9 0%, #f1f5f2 100%);
        }
    ...
    <body>
        <nav class="nav">
            <div class="shell">
                ...
                %>
                <a class="btn btn-primary" href="Book_maintenance.jsp">Book Maintenance →</a>
            </div>
        </nav>
        ...
        <main class="maintenance-page">
            <section class="booking-container">
                <div class="page-heading">
                    <p class="section-tag">CAR CARE</p>
                    <h1>Book Your Maintenance</h1>
                    <p>Keep your car performing at its best. Tell us what your vehicle needs, and we'll help you schedule the right service.</p>
                </div>
                    ...
                    <form action="Maintenance_User" method="post">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" id="carModel" name="carModel" placeholder="e.g. Hyundai Creta" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="purchaseYear">Car Purchase Year</label>
                                <input type="number" id="purchaseYear" name="purchaseYear" placeholder="e.g. 2023" min="1900" max="2030" required>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="description">Describe Your Maintenance Requirement</label>
                            <textarea id="description" name="description" rows="6" placeholder="Tell us about any issues, unusual sounds, warning lights, or maintenance requirements..." required></textarea>
                        </div>

                        <div class="form-footer">
                            <p class="form-note">Our team will review your request and get back to you.</p>
